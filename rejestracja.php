	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 text-center">
				<h1 class="text-center monoton pink-strong menu-h1">Rejestracja</h1>
			...
			<div class="row justify-content-center row-select row-pad">
				...
				<form class="text-white lato w-50 p-text" action="rejestruj.php" method="POST">
							<div class="form-row">
							    <div class="form-group col-6">
							      <label>Imię</label>
							      <input type="text" class="form-control order-area" size="80" name="imie">
							    </div>
							    <div class="form-group col-6">
							      <label>Nazwisko</label>
							      <input type="text" class="form-control order-area" size="80" name="nazwisko">
							    </div>
							  </div>					
							  <div class="form-row">
							...
							<div class="form-row">
							    <div class="form-group col-6">
							      <label>Hasło</label>
							      <input type="password" class="form-control order-area" size="80" name="haslo1">
							    </div>
							    <div class="form-group col-6">
							      <label>Powtórz hasło</label>
							      <input type="password" class="form-control order-area" size="80" name="haslo2"> 
							    </div>
							</div>
						    ...
						    <div class="row">
						      <div class="col-6">
						        <div class="form-check">
						          <input class="form-check-input" type="checkbox" name="regulmin">
					...
					<div class="form-row">
						<div class="form-group col-12">	
						  <button type="submit" class="order-button lato-bold ml-1">Rejestruj</button>
						</div>  
					</div>
				</form>
...
<!-- ////////////////Stopka////////////////  -->
	...
	<div class="container-fluid">
		...
		<script type="text/javascript" src="script-rejestracja.js"></script>
</body>
</html>