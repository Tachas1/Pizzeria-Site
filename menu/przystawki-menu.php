	...
	<div class="container-fluid">
		...
		<div class="row pt-2" style="margin-left: 2vh!important; margin-right: 2vh!important;">
			...
			<?php
				...
				$textQuery = "SELECT nazwa, opis, cena FROM przystawki;";	
				$queryPrzystawki = mysqli_query($connect, $textQuery);
					while ($row = mysqli_fetch_assoc($queryPrzystawki)){
						...
						"<div ". "class='row element-border pt-4 pb-4'".">".
							"<div class="."col-2".">".
								...
								"</div>".
								"<div class="."col-1".">".
									"<p "."class='text-white lato p-text'".">".$row['cena']."0 zł</p>".
								"</div>".
								"<div class="."col-1".">".
									"<p "."class='text-white lato p-text'".">"."</p>".
								"</div>".
